...
class ModelApp:
    ...
    def setup_window(self):
        self.root.title("Regression Wizard - v0.79 the bio update :3")
    ...
    def create_model_selection(self, parent):
        ...
        self.category_dropdown = ttk.Combobox(dropdown_frame, 
                                            ...
                                            values=["Sigmoidales", "Polinomiales", "Inversos polinomiales", "Modelos de campana", "Decaimiento Exponencial", "Crecimiento exponencial limitado", "Modelos de Potencia", "Ciencia-Bio"],
                                            state="readonly",
                                            width=30)
