...
class ModelApp:
    ...
    def setup_styles(self):
        ...
        # Estilo para el botón de procesar (gris con texto negro)
    ...
    def create_data_entry(self, parent):
        ...
        # Área para campos de datos con scroll horizontal
        ...
        self.data_canvas.configure(xscrollcommand=self.scrollbar_x.set)
    ...
    def create_results_display(self, parent):
        ...
        # Barra de desplazamiento vertical para la tabla de resultados
