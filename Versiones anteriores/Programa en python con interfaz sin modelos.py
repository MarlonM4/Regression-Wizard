...
class ModelApp:
    ...
    def create_data_entry(self, parent):
        ...
        ttk.Button(control_frame, text="Generar Campos", command=self.generate_fields).pack(side="left", padx=10)
        ...
        ttk.Button(parent, text="PROCESAR MODELOS", style='Process.TButton', command=self.process_models).pack(pady=10)
    ...
    def process_models(self):
        ...
        # Lista de modelos con sus parámetros y nombres de parámetros
        modelos = [
            {
            ...
            # Resto de modelos con la misma estructura...
        ]
        ...
        for model in modelos:
            try:
                ...
                # Formatear parámetros con nombres
